            ...
            <div class="text-center">
                <div className="py-4 row align-items-md-center">
                    <div className="col-md-6">
                        <img src="https://images.pexels.com/photos/326559/pexels-photo-326559.jpeg?auto=compress&cs=tinysrgb" alt="Swoldier Description" className="img-fluid about-photo" />
                    </div>
                ...
                <div className="py-4 row align-items-md-center">
                    <div className="col-md-6 order-md-2">
                        <img src="https://images.pexels.com/photos/343/man-couple-people-woman.jpg?auto=compress&cs=tinysrgb" alt="Swoldier Description" className="img-fluid about-photo" />
                    </div>
                ...
                <div className="py-4 row align-items-md-center">
                    <div className="col-md-6">
                        ...
                        <img src="https://images.pexels.com/photos/39671/physiotherapy-weight-training-dumbbell-exercise-balls-39671.jpeg?auto=compress&cs=tinysrgb" alt="Swoldier Description" className="img-fluid about-photo" />
                    </div>
                    <div className="col-md-6 text-md-left">
